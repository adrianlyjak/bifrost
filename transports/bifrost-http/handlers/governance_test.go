...
func TestGetVirtualKeyQuota_ExternalResolverReplacesWithAccessProfileBudgets(t *testing.T) {
	...
	RegisterExternalQuotaBudgetResolver(func(_ context.Context, vk *configstoreTables.TableVirtualKey) (*ExternalQuotaBudgetResult, error) {
		if vk.ID != "vk-1" {
			return nil, nil
		}
	...
	defer RegisterExternalQuotaBudgetResolver(nil)
...
func TestGetVirtualKeyQuota_ExternalResolverErrorFailsClosed(t *testing.T) {
	...
	RegisterExternalQuotaBudgetResolver(func(_ context.Context, _ *configstoreTables.TableVirtualKey) (*ExternalQuotaBudgetResult, error) {
